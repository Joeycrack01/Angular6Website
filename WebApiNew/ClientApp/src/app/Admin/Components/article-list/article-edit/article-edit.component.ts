...
export class ArticleEditComponent implements OnInit {
 ...
 public sections: SectionModel[];
  ...
  constructor(private fb: FormBuilder, private router: Router, private route: ActivatedRoute, private _articleService: ArticleServiceService, private _categoryService: CategoryServiceService, private _sectionService: SectionServiceService, private toastr: ToastrService) {
    // With FormBuilder
  ...
  notify() {
    this.toastr.success('Added successfully', 'sucess', {
      timeOut: 3000
    });
  }
}
